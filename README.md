...
I’m a **Mobile App Developer** passionate about building **scalable, secure, and user-friendly applications**.
- 🚀 Skilled in **Flutter** for cross-platform mobile apps.
- ⚡ Backend experience with **Node.js, Nest.js & REST APIs**.
- ☁️ Familiar with **Cloud services** (Firebase, GCP, AWS S3).
- 🏢 Ex-Intern @ **Medkart** (Flutter Developer | E-commerce & Stock Audit Modules).
- 🎯 Currently exploring **full-stack development** (Flutter + Node.js + Cloud).

---

### 🔥 Rapidfire

- 🔭 I’m currently working on **Orbit – An Anonymous Chat & Feed App**.
- 🌱 Learning **advanced state management & system design**.
- ❓ Ask me about **Flutter, Node.js, Authentication systems**.
...
| :--- | :--- | :--- |
| **Orbit** | An anonymous chat and feed app designed for secure, private communication. | Flutter, Node.js, Nest.js, MongoDB, Firebase |
| **Medkart Modules** | Developed e-commerce and stock audit functionalities during my internship. | Flutter, Django, REST APIs |
...
<a href="https://supabase.com/" target="_blank"><img style="margin: 10px" src="https://avatars.githubusercontent.com/u/54469796?s=200&v=4" alt="Supabase" height="40" /></a>
...
<a href="https://nestjs.com/" target="_blank"><img style="margin: 10px" src="https://nestjs.com/img/logo-small.svg" alt="Nest.js" height="40" /></a>
...
<a href="https://www.w3schools.com/c/" target="_blank"><img style="margin: 10px" src="https://profilinator.rishav.dev/skills-assets/c-original.svg" alt="C" height="40" /></a>
...
<div align="center">✨ *Always building. Always learning.* ✨</div>
